...
export type ModelType = 'gemini-2.5-pro' | 'gemini-2.5-flash' | 'gpt-5.1';
...
async function executeExtraction(
  ...
  // Use Gemini 2.5 Pro for extraction (stable, proven)
  const modelName: ModelType = model === 'gemini' ? 'gemini-2.5-pro' : 'gpt-5.1';
