/**
 * Test Health Check on Grupo Pounj real data
 */
...
const DATA_DIR = '/Users/ashishpunj/kyc-docx-mcp-191125/data/grupo-pounj-gemini/runs';

async function main() {
  console.log('🔍 Loading latest Grupo Pounj run...\n');
